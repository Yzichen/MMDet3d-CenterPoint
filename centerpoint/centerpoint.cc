...
void CenterPoint::InitParams(const std::string model_config) {
  ...
  cout << min_x_range_ << endl;
  cout << min_y_range_ << endl;
  cout << min_z_range_ << endl;
  cout << max_x_range_ << endl;
  cout << max_y_range_ << endl;
  cout << max_z_range_ << endl;
  ...
  cout << grid_x_size_ << endl;
  cout << grid_y_size_ << endl;
  cout << grid_z_size_ << endl;
  ...
  cout << head_x_size_ << endl;
  cout << head_y_size_ << endl;
  cout << head_map_size_ << endl;
